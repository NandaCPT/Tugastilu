...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Ketan Susu Coklat");
        mListMenu.add("Ketan Susu Es Krim");
        mListMenu.add("Ketan Susu Durian");
        mListMenu.add("Ketan Susu Original");
        mListMenu.add("Ketan Susu Keju");
        mListMenu.add("Ketan Hitam");
        mListMenu.add("Ketan Susu Mentega");
        mListMenu.add("Ketan Susu Nangka");
        mListMenu.add("Ketan Susu Gula Jawa");
    ...
    public void onClickPlus(View view) {
        harga = harga + 15000; //logic tombol >
        qty = qty + 1;
